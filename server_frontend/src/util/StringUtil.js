 ...
 * @return
 */
export function getTrimmedString(s) {
 ...
 * @return
 */
export function getNoBlankString(s) {
 ...
 * @return
 */
export function isEmpty(s, trim) {
  if (s == null) {
    return true;
  }
  if (trim) {
 ...
 * @return
 */
export function firstCase(key, upper) {
 ...
 * @return
 */
export function toUpperCase(s, trim) {
 ...
 * @return
 */
export function toLowerCase(s, trim) {
  s = trim ? this.getTrimmedString(s) : this.getString(s);
